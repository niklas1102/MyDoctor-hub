...
from appointment.integration_views import (
    booking_home, service_booking, my_appointments, booking_confirmation, 
    cancel_appointment, get_available_slots_api
)
...
urlpatterns = [
    path('', booking_home, name='booking_home'),  # Integration home page
    path('my-appointments/', my_appointments, name='my_appointments'),  # User's appointments
    path('service/<int:service_id>/', service_booking, name='service_booking'),  # Service booking
    path('confirmation/<int:appointment_id>/', booking_confirmation, name='booking_confirmation'),  # Booking confirmation
    path('cancel/<int:appointment_id>/', cancel_appointment, name='cancel_appointment'),  # Cancel appointment
    path('api/available-slots/', get_available_slots_api, name='get_available_slots_api'),  # API for available slots
    
    # Original appointment system URLs
    path('legacy/', appointments_home, name='appointments_home'),
