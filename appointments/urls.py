...
urlpatterns = [
    ...
    path('doctor/patient/<int:patient_id>/', views.doctor_patient_overview, name='doctor_patient_overview'),
    path('doctor/encounter/<int:encounter_id>/', views.doctor_encounter_view, name='doctor_encounter_view'),
