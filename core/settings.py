...
CSRF_TRUSTED_ORIGINS = [ 'https://mydoctor-hub-c052677a5661.herokuapp.com', 'http://mydoctor-hub-c052677a5661.herokuapp.com','http://localhost:8000', 'http://localhost:5085', 'http://127.0.0.1:8000', 'http://127.0.0.1:5085']
